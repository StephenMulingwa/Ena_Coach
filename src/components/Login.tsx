  ...
  return (
    ...
    >
      ...
      >
          ...
          <img
            src="/Ena_Login.gif"
            alt="Ena Coach buses on the highway"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Sign in to access the Ena <span style={{ color: "var(--accent)", fontWeight: 600 }}>Fleet Insights</span> portal.
            </p>
          ...
          >
            © {year ?? ""} Ena Coach Ltd. All rights reserved.
          </p>
        </div>
      </section>
    </div>
